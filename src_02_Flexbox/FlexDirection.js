    ...
    render() {
        return (
            <ScrollView>
                ...
                <View>
                    <Text style={[styles.h3]}>flexDirection:'row'(default)</Text>
                ...
                <View>
                    <Text style={[styles.h3]}>flexDirection:'column-reverse'(default)</Text>
                ...
                <View>
                    <Text style={[styles.h3]}>flexDirection:'row-reverse'(default)</Text>
